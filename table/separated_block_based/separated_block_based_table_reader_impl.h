...
// The file contains some member functions of SeparatedBlockBasedTable that
...
TBlockIter* SeparatedBlockBasedTable::NewDataBlockIterator(
...
// If input_iter is not null, update this iter and return it
template <typename TBlockIter>
TBlockIter* SeparatedBlockBasedTable::NewDataBlockIterator(const ReadOptions& ro,
                                                  CachableEntry<Block>& block,
